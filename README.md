...
```go
import _ "github.com/nuln/agent-plugins/pipe/dedup"
```
...
| 插件 | Priority | 模块路径 | 说明 |
|------|----------|----------|------|
| [management](#management) | 30 | `.../pipe/management` | HTTP 管理 API |
| [heartbeat](#heartbeat) | 40 | `.../pipe/heartbeat` | 定时心跳注入 |
| [webhook](#webhook) | 50 | `.../pipe/webhook` | HTTP Webhook 接收 |
| [telemetry](#telemetry) | 100 | `.../pipe/telemetry` | 消息日志记录 |
| [dedup](#dedup) | 200 | `.../pipe/dedup` | 消息去重 |
| [userroles](#userroles) | 250 | `.../pipe/userroles` | 角色限流（手动注册） |
| [ratelimiter](#ratelimiter) | 300 | `.../pipe/ratelimiter` | 全局滑动窗口限流 |
| [langdetector](#langdetector) | 400 | `.../pipe/langdetector` | 语言检测 |
| [redactor](#redactor) | 500 | `.../pipe/redactor` | API Key 等敏感信息脱敏 |
| [contextinjector](#contextinjector) | 600 | `.../pipe/contextinjector` | 注入时间戳等上下文 |
| [guardrail](#guardrail) | 700 | `.../pipe/guardrail` | 危险操作拦截 |
| [router](#router) | 900 | `.../pipe/router` | `/llm <name>` 切换 LLM |
| [command](#command) | 1000 | `.../pipe/command` | 自定义斜杠命令 |
...
```go
import "github.com/nuln/agent-plugins/pipe/userroles"
